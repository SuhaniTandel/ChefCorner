 ...
 useEffect(() => {
  ...
  setTimeout(() => {
    ...
    if ($ && $.fn.owlCarousel) {
      ...
      const slider = $(".nav-control-layout1");
            ...
            <div class="container">
                <div class="row gutters-60">
                    <div class="col-lg-8">
                        ...
                        <div class="blog-box-layout1">
                            <div class="item-figure">
                                <a href="single-blog.html"><img src="/assets/img/blog/blog10.jpg" alt="Blog"/></a>
                            </div>
                            <div class="item-content">
                                <ul class="entry-meta">
                                    <li><a href="#"><i class="fas fa-clock"></i>15 December, 2018</a></li>
                        ...
                        <div class="blog-box-layout1">
                            <div class="item-figure">
                                <a href="single-blog.html"><img src="/assets/img/blog/blog11.jpg" alt="Blog"/></a>
                            </div>
                            <div class="item-content">
                                <ul class="entry-meta">
                                    <li><a href="#"><i class="fas fa-clock"></i>15 December, 2018</a></li>
                        ...
                        <div class="blog-box-layout1">
                            <div class="item-figure">
                                <a href="single-blog.html"><img src="/assets/img/blog/blog12.jpg" alt="Blog"/></a>
                            </div>
                            <div class="item-content">
                                <ul class="entry-meta">
                                    <li><a href="#"><i class="fas fa-clock"></i>15 December, 2018</a></li>
                        ...
                        <div class="blog-box-layout1">
                            <div class="item-figure">
                                <a href="single-blog.html"><img src="/assets/img/blog/blog13.jpg" alt="Blog"/></a>
                            </div>
                            <div class="item-content">
                                <ul class="entry-meta">
                                    <li><a href="#"><i class="fas fa-clock"></i>15 December, 2018</a></li>
